...
urlpatterns = [
    ...
    path('treasurer-dashboard/budget/', views.budget_management, name='budget_management'),
    path('treasurer-dashboard/budget/add/', views.add_budget, name='add_budget'),
    path('treasurer-dashboard/budget/<int:pk>/edit/', views.edit_budget, name='edit_budget'),
    path('treasurer-dashboard/budget/<int:pk>/delete/', views.delete_budget, name='delete_budget'),
    ...
    path('admin-panel/budget/', views.budget_management, name='admin_budget_management'),
    path('admin-panel/budget/add/', views.add_budget, name='admin_add_budget'),
    path('admin-panel/budget/<int:pk>/edit/', views.edit_budget, name='admin_edit_budget'),
    path('admin-panel/budget/<int:pk>/delete/', views.delete_budget, name='admin_delete_budget'),
